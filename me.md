...
`de` Open Sourcing and Release Engineering @ Eclipse.org - The Making of an Eclipse Project - Mai: [JAXenter][p.2012.jaxenter]; Januar: Eclipse Magazin
...
`de` Refaktorisieren von Tests: Erfahrungen aus der schlüsselwortgetriebenen Testentwicklung - Juni: [OBJEKTspektrum][p.2010.os]
...
`en` Test design for stubborn applications - Event handling in automated acceptance tests - March: [*t*esting *e*xperience][p.2010.te]
